# BookTrack
Kitaplarınızı burada kaydedip okuduğunuz sayfaları, nerede kaldığınızı ve kitaplarınızı görebileceğiniz bir uygulama. Geliştirmeye açıktır, basic python bilgisi ile yeni başlayanların yapabileceği iyi, yararlı ve minimal bir proje olması amacıyla tasarlanmıştır.

# main.py
Python'a yeni başlayanların kolaylıkla örnek alarak yapabileceği bir dosyadır. Eğer yeniyseniz ve örnek olarak bu projeyi yapmak istiyorsanız main.py'dan başlamanız önerilir.

# bookmain.py
Bu dosya, customtkinterda kullandığı için main.py'a göre yapımı daha zordur. Fakat yapımı bazı programlarla kolay hale getirilebilir.
